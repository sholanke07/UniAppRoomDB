...
public class MainActivity2 extends AppCompatActivity implements Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(MainActivity2.this);
    ...
    private void Menu(){
        PopupMenu p = new PopupMenu(MainActivity2.this, menubtn);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.view:
                        ...
                        return true;
                        case R.id.aboutus:
                        Intent intent3 = new Intent(MainActivity2.this, AboutUs.class);
                        startActivity(intent3);
                        return true;
                    case R.id.aboutpolicy:
